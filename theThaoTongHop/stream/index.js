...
async function listVD(id){
    const API = await getAPI(`https://tv-web.api.vinasports.com.vn/api/v2/publish/event/related-to/?id=${id}&type=2&page_num=2&page_size=10`)
 ...
 function encodeObj(obj) {
    ...
    const html = API.data.map(i => {
        ...
        return `
        <a href="/theThaoTongHop/stream/index.html?id=${base64}">
